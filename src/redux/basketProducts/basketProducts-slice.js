...
const getBasketProductsSlice = createSlice({
...
export const basketProductsActions = getBasketProductsSlice.actions;

export default getBasketProductsSlice.reducer;
